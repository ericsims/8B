...
main:
    ...
    ; add string to FIFO
    load a, #(conn_http_get.end-conn_http_get)
    loadw hl, #conn_http_get
    .copy:
        load b, (hl)
    ...
    storew #(conn_http_get.end-conn_http_get), W5300_SOCK0+Sn_TX_WRSR2 ; set tx length, without null termination
...
#bank rom
conn_ip: #d8 104, 18, 2, 24 ;  ip addr for example.org
conn_port: #d16 80 ;  port 80
conn_http_get: #d "GET / HTTP/1.1\nHost:example.org\nConnection: close\n\n"
.end:
